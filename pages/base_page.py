...
class BasePage:
    ...
    lastChanceLink = '#eyebrow-last\ chance a'
    justInLink = '#eyebrow-just\ in a'
    franchiseMenuItem = '#eyebrow-franchise'
    videoGamesMenuItem = '#eyebrow-video\ games'
    merchandiseMenuItem = '#eyebrow-merchandise'
    ffXIVMerchandiseMenuItem = '#eyebrow-ffxiv\ merchandise'
